...
:doit
  ...
  set PERL5LIB=C:/GIT/ARCHIVE/rendercv-v1/rendercv/tinytex-release/TinyTeX/tlpkg/tlperl/lib
...
:update
  ...
  if errorlevel 1 goto :rollback
  >>"C:/GIT/ARCHIVE/rendercv-v1/rendercv/tinytex-release/TinyTeX/texmf-var/web2c/tlmgr.log" echo [%date% %time%] self update: texlive.infra ^(69447 -^> 69740^)
...
:rollback
  >>"C:/GIT/ARCHIVE/rendercv-v1/rendercv/tinytex-release/TinyTeX/texmf-var/web2c/tlmgr.log" echo [%date% %time%] failed self update: texlive.infra ^(69447 -^> 69740^)
  ...
  tlpkg\tlperl\bin\perl.exe .\texmf-dist\scripts\texlive\tlmgr.pl _include_tlpobj tlpkg\tlpobj\texlive.infra.tlpobj
  if errorlevel 1 goto :panic
  >>"C:/GIT/ARCHIVE/rendercv-v1/rendercv/tinytex-release/TinyTeX/texmf-var/web2c/tlmgr.log" echo [%date% %time%] self restore: texlive.infra ^(69447^)
...
:panic
  >>"C:/GIT/ARCHIVE/rendercv-v1/rendercv/tinytex-release/TinyTeX/texmf-var/web2c/tlmgr.log" echo [%date% %time%] failed self restore: texlive.infra ^(69447^)
